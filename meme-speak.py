...
def do_argparse():
    ...
    parser.add_argument("strings", metavar="string", help="a string you would like to memeify", nargs="+")
...
def memeify(my_str: str) -> str:
    ...
    for i, char in enumerate(char_list):
        if i > 2:
            if random.randint(0, 1) == 0 and char_list[i - 1].isupper() or char_list[i - 2].isupper():
